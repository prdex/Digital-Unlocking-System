...
public class VerifyPhone extends AppCompatActivity {
        ...
        findViewById(R.id.buttonVerify).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                    ...
                    if(code.isEmpty() || code.length() <6){
                        editText.setError("Entet Valid Code");
        ...
        mAuth.signInWithCredential(credential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                    ...
                    Toast.makeText(VerifyPhone.this,"ERROR Verifying", Toast.LENGTH_LONG).show();
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks mCallBack = new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
        ...
        public void onVerificationFailed(FirebaseException e) {
            Toast.makeText(VerifyPhone.this, "Verication failed", Toast.LENGTH_LONG).show();
